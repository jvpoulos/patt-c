...
%	
\begin{align*}
Y_{isd} &= a + bD_i + c_1W^{1}_i + c_2W^{2}_i + \textcolor{red}{c_3W^{4}} +dU_i, \textrm{ where} \\
b &= \left\{
			\begin{array}{rr}
...
\end{align*}	
%
The treatment effect $b$ is heterogeneous. We set $a, c_1, \textcolor{red}{c_3,}$ and $d$ to $1$ and $c_2$ to $2$. 
