...
\begin{figure}[htbp]
	\begin{center}
		...
		\caption{Heterogeneity in sample and population treatment effect estimates: $\#$ ER visits.\label{fig:num-visit-plot}}
		%\vspace{10mm}
...
\begin{figure}[htbp]
	\begin{center}
		...
		\caption{Heterogeneity in sample and population treatment effect estimates: $\#$ outpatient visits.\label{fig:num-out-plot}}
		%\vspace{10mm}
