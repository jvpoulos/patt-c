...
\begin{figure}[htbp]
	\begin{center}
		...
		\caption{Simulated RMSE, binned by compliance rate and percent eligible for the RCT. Darker tiles correspond to higher RMSE and gray tiles indicates no data.\label{fig:rmse_ratec_rates}}
