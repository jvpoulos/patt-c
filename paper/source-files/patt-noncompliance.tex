...
\textcolor{red}{ %yau2001inference
We compare the population estimators the sample Complier Average Causal Effect (CACE) \citep{imbens1997bayesian}, which is the ITT effect divided by the share of treated compliers in the RCT:
%	
\begin{equation}\label{tsatec}
\tau_{\text{CACE}} = \ex\left( Y_{i11} - Y_{i10} \mid S_i=1\right) / \pr(T_i = D_i = 1 \mid S_i=1).
\end{equation}	
%
...
\begin{figure}[htbp]
	\begin{center}
		...
		\caption{Simulated RMSE, binned by compliance rate and percent eligible for the RCT.\label{fig:rmse_ratec_rates}}
...
\begin{figure}[htbp]
	\begin{center}
		...
		\caption{Simulated RMSE, binned by compliance rate and treatment rate. White tiles correspond to missing simulated data. \label{fig:rmse_ratec_ratet}}
