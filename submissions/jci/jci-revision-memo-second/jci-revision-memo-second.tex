...
%Exchangability in the RCT
%normally estimate ate as a function of covariates in the RCT first and then project to population
% We're estimating Yi1, Yi0, as a function of covariates
% We only want it for compliers, and don't know who the compliers are in the population

%it is performing more poorly because it isn't adjusted for compliance
...
% Problem is that we don't know compliance rate in the population
...
%** NEW EXAMPLE: If propensity to recertify is correlated with unobserved variables
% We don't have a covariate on recertification
