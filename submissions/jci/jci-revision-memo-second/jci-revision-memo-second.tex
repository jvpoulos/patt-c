...
\begin{itemize}
	...
	\end{itemize}
	\item Weight descriptive statistics and treatment effect using survey weights. The OHIE survey weights account for the probability of being sampled and survey procedures. The NHIS survey weights adjust for the probability of selection and non-response. 
\end{itemize}
