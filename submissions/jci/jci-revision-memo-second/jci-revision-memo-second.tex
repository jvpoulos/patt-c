...
\begin{itemize}
	...
	\end{itemize}
	\item Weight descriptive statistics using survey weights. The OHIE survey weights account for the probability of being sampled and survey procedures. The NHIS survey weights adjust for the probability of selection and non-response. Survey weights are also used for modeling and treatment effect estimation as follows:
		\begin{itemize}
