...
Following the guidance of R1 and the Editor, we refer to this quantity in the revised manuscript as the Sample Average Treatment Effect on Treated Compliers (SATE-C) and define its estimator in Eq. \ref{tsatec}. 
